          ...
          <div className="px-6 py-4 space-y-3">
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-500">Compartir en tu perfil profesional</p>
              </div>
            </button>
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-500">Compartir en tu timeline</p>
              </div>
            </button>
            ...
            <div className="relative py-2">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-white px-2 text-gray-500">O descargá el PDF</span>
              </div>
            </div>
