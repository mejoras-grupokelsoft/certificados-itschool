...
import { downloadPdfLocally, getWhatsAppShareLink, getEmailShareLink, getLinkedInShareLink, getXShareLink } from '@/lib/shareCertificateService';
        ...
        <div className="bg-white rounded-2xl shadow-2xl max-w-sm w-full animate-scale-in overflow-hidden">
          ...
          <div className="px-5 py-4">
            ...
            <button
              ...
              className="w-full flex items-center justify-between px-4 py-3 rounded-xl bg-gray-50 hover:bg-gray-100 transition-colors mb-3"
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-[#4285F4] hover:bg-[#3b78db] text-white font-medium transition-colors disabled:opacity-50"
            >
              {downloading ? (
                <>
